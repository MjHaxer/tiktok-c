...
<body>
    <div class="container">
        <h1>RED ROOM</h1>
        <p>You choose Spectator Access.<br>After confirmation you will get full access.</p>
        <div class="qr-code">
            <img src="qr-code.png" alt="QR Code">
        </div>
        <div class="payment-details">
            <p>Pay amount</p>
            <input type="text" value="0.00089 BTC" readonly>
            <p>To Bitcoin address</p>
            <input type="text" value="193s9w7A3iarmte7MHJeSuQt3S9HyDNeHo" readonly>
            <p class="instructions">Send exactly 0.00089 BTC.NETWORK(BITCOIN) This address will be working only one complete payment.</p>
        </div>
